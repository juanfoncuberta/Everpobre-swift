...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var noteDetailNavigation: UINavigationController!
    var noteTVC: NoteTableViewController!
    var noteTNavigation:UINavigationController!
...
//            splitVC.viewControllers = [noteTNavigation, noteDetailVC.wrappedInNavigation()]
